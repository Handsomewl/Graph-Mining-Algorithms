...
def divide_connected_conponents(res, amt_tensor, cmt_tensor):
    ...
    for top_i in range(len(res)):
        ...
        subgraph_score_list.extend([score] * len(subgraph_connected_list_topi))
    ...
    return subgraph_connected_list, subgraph_timebin_list, subgraph_timebin_idx_list, subgraph_can_divided, subgraph_score_list
...
def handle_big_graph(subgraph_connected_list, subgraph_timebin_list, subgraph_timebin_idx_list, subgraph_can_divided, subgraph_score_list, max_node_limit,
    ...
    while curr_i < len(subgraph_connected_list):
        ...
        if len(m_list_tmp) > max_node_limit:
            ...
            if handle_biggraph_type == 1:
                ...
                # 复用拆分连通子图代码
                curr_subgraph_connected_list, curr_subgraph_timebin_list, curr_subgraph_timebin_idx_list, curr_subgraph_can_divided, curr_subgraph_score_list \
                ...
                subgraph_score_list.extend(curr_subgraph_score_list)
            ...
            del subgraph_score_list[curr_i]


        else:
            curr_i += 1

    return subgraph_connected_list, subgraph_timebin_list, subgraph_timebin_idx_list, subgraph_score_list
