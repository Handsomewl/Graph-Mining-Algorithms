...
class CubeFlowPlus(DMmodel):
    ...
    def run(self, **params):
        ...
        # 步骤一：划分大图为连通子图
        subgraph_connected_list, subgraph_timebin_list, subgraph_timebin_idx_list, subgraph_can_divided, subgraph_score_list = \
        ...
        subgraph_connected_list, subgraph_timebin_list, subgraph_timebin_idx_list, subgraph_score_list = \
            handle_big_graph(subgraph_connected_list, subgraph_timebin_list, subgraph_timebin_idx_list,
                             subgraph_can_divided, subgraph_score_list, self.max_node_limit,
